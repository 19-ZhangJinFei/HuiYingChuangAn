    ...
    <div class="login">
        <div class="login-main">
            ...
            <div class="right">
                ...
                <div class="bottom">
                    <div class="register-btn" @click="router.push('/register')">立即注册</div>
                    <div class="find-pass" @click="router.push('/renew')">找回密码</div>
                </div>
            </div>
        </div>
...
import Dialog from './components/agreement.vue'
